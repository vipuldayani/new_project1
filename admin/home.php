...
if (isset($_REQUEST['submit'])) {
    ...
    if(!empty($_POST['id']))
    {
          $gettbl_home = mysqli_query($con, " UPDATE tbl_home SET switch = '".$switch."', main_title='" . $_POST['main_title'] . "', sub_title='" . $_POST['sub_title'] . "' WHERE id='" . $_POST['id'] . "' ");    
    }
    else
    {
        $gettbl_home = mysqli_query($con, "INSERT INTO `tbl_home`(`switch`, `main_title`, `sub_title`) "
            . "VALUES ('".$switch."','" . $_POST['main_title'] . "','" . $_POST['sub_title'] . "','" . $image . "' )");
