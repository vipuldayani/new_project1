...
if (isset($_REQUEST['submit'])) {
    ...
    if(!empty($_POST['id']))
    {
         $gettbl_aboutus = mysqli_query($con, " UPDATE tbl_aboutus SET switch = '".$switch."',about_title='".$_POST['about_title']."',latest_title='".$_POST['latest_title']."' WHERE id ='" . $_POST['id'] . "' ");    
    }
     else
     {

     $gettbl_aboutus = mysqli_query($con, "INSERT  INTO tbl_aboutus(`switch`,`about_title`,`latest_title`)"
                . "VALUES ('".$switch."','" . $_POST['about_title'] . "','" . $_POST['latest_title'] . "')");
...
if (isset($_REQUEST['imageSubmit'])) {
    ...
    $gettbl_aboutus_image = mysqli_query($con, "INSERT INTO tbl_aboutus_image(`image`,`name`) "
                                    ...
                                    <div id="pay-invoice">
                                        <div class="card-body">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $result_image = mysqli_query($con, "select * from tbl_aboutus_image  ");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="aboutusedit.php?id=<?= $row_image['id'] ?>" class="btn btn-info">Edit</a>
                                                            <a href="aboutusdelete.php?id=<?= $row_image['id'] ?>" class="btn btn-warning">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    }
