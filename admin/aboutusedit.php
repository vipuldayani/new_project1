...
mysqli_query($con, "UPDATE tbl_aboutus_image SET image = '" . $image . "',name='".$_POST['name']."' WHERE id = '".$_POST['image_id']."' ");
...
$select_query = mysqli_query($con, "SELECT * FROM `tbl_aboutus_image` WHERE id = '" . $_GET['id'] . "' ");
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">About image</strong>
                        </div>
                        <div class="card-body">
                            <!-- Credit Card -->
                            <div id="pay-invoice">
